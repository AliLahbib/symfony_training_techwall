 ...
 */
final class Version20240606213043 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE person_hobby ADD CONSTRAINT FK_9552ECF3217BBB47 FOREIGN KEY (person_id) REFERENCES person (id)');
        ...
        $this->addSql('ALTER TABLE person ADD profile_id INT DEFAULT NULL, ADD job_id INT DEFAULT NULL, DROP profile, DROP hobbies, DROP job');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE person ADD profile VARCHAR(255) DEFAULT NULL, ADD hobbies VARCHAR(255) DEFAULT NULL, ADD job VARCHAR(255) DEFAULT NULL, DROP profile_id, DROP job_id');
    }
}
